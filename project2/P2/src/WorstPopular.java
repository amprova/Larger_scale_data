...
public class WorstPopular {
				...
				throws IOException, InterruptedException
		{
	        ...
	        { 	
				if(count<max)
				{
		            ...
		            context.write(new Text("#Rating1: "+rate), new Text("Title: "+s));
		            count++;
				}
	...
	ClassNotFoundException, InterruptedException
	{
		...
		job1.setJarByClass(WorstPopular.class);
		...
		job2.setJarByClass(WorstPopular.class);
